    ...
    <LayoutWrap>
      <DetailSection>
        ...
        <InfoTxtWrap>
          ...
          <InfoList>
            <li>
              <strong>홍익대학교의 아이덴티티</strong>를 표현할 수 있는 와우산,
              교내 조형물 등을 적극 활용하여 아이콘 제작
            </li>
            <li>
              인쇄소와 직접 연락하여
        ...
        <ProjectContents detailImg={DetailImg3} detailTxt="최종 작업 인쇄물" />
        ...
        <ProjectContents detailImg={DetailImg5} detailTxt="최종 작업 인쇄물" />
      </DetailSection>
    </LayoutWrap>
  );
};
